...
![1661753812643](assets\1661753812643.png)
...
![1661744596637](assets\1661744596637.png)

### 3.常见CMD命令

盘符切换：`盘符名称 :`

![1661754213846](assets\1661754213846.png)

列出当前目录下的文件及文件夹：`dir`

![1661754301367](assets\1661754301367.png)

进入指定目录：`cd xxx/yyy`	

![1661754548969](assets\1661754548969.png)

退回上级目录：`cd ..`

![1661754609952](assets\1661754609952.png)

退回当前目录：`cd .`

![1661754679256](assets\1661754679256.png)

退回根目录：`cd /`

![1661754727377](assets\1661754727377.png)

创建目录：`md xxx`

![1661754872010](assets\1661754872010.png)

删除目录：`rd xxx`

![1661754918867](assets\1661754918867.png)
...
![1661755451224](assets\1661755451224.png)

②`Win+R`打开CMD命令行

![1661755182099](assets\1661755182099.png)

③切换盘符后，进入`QQ.exe`所在路径

![1661755694584](assets\1661755694584.png)

#### 4.2.实现任意目录下输入QQ.exe都能启动QQ

QQ是频繁使用的软件，每次打开都需要切换盘符、进入多层目录，太麻烦了，但是在其他目录下输入`QQ.exe`会报错，因为其他路径下并没有`QQ.exe`文件，那如何解决？

![1661756015238](assets\1661756015238.png)
...
![1661757990964](assets\1661757990964.png)

![1661758200905](assets\1661758200905.png)

![1661758392680](assets\1661758392680.png)

![1661758416995](assets\1661758416995.png)

![1661758760652](assets\1661758760652.png)
...
![1661761998776](assets\1661761998776.png)

![1661762261435](assets\1661762261435.png)

![1661762080565](assets\1661762080565.png)

![1661762153552](assets\1661762153552.png)
...
![1661765013292](assets\1661765013292.png)

②新建`JAVA_HOME`

![1661765241512](assets\1661765241512.png)

③双击[Path]

![1661765485790](assets\1661765485790.png)
...
![1661759849178](assets\1661759849178.png)
...
> 后缀名隐藏的修改办法
>
> ![1661759945501](assets\1661759945501.png)

> 使用记事本看代码不太方便，可下载高级记事本`Notepad++`打开Java代码，一些相关设置请自行百度

②编译程序：`javac 文件名.java`

![1661765851144](assets\1661765851144.png)

③运行程序：`java 文件名`

![1661765902758](assets\1661765902758.png)

> 编译和运行如何理解？首先Windows不认识Java代码，从而无法运行Java代码，那怎么办？
>
> ![1661759640907](assets\1661759640907.png)
>
> 既然操作系统不认识Java代码，那么首先就将Java代码翻译成操作系统能看得懂的内容，即编译
>
> ![1661759742987](assets\1661759742987.png)
>
> 运行的是翻译以后的文件
...
![1661761265518](assets\1661761265518.png)
...
![1661761480078](assets\1661761480078.png)
...
![1661761533655](assets\1661761533655.png)

#### 3.4.自身特点

面向对象、安全性(Java写出来的代码安全，漏洞较少)、多线程(同时做多件事)、简单易用、开源、**跨平台(跨OS)**

![1661761872899](assets\1661761872899.png)
...
![1661767728617](assets\1661767728617.png)

只需要满足JVM规范可自定义JVM，HotSpot VM是JVM的实现

### 5.JVM&JRE&JDK

通过以上的学习，请思考![img](assets\4827431.PNG)我们的程序从开发到运行需要使用到哪些工具呢？？
...
![1661768279634](assets\1661768279634.png)
...
![1661768563957](assets\1661768563957.png)
